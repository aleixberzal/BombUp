...
public class ChallengeEnd : MonoBehaviour
{
    ...
    private void EndGame()
    {
        gameEnded = true;
        Time.timeScale = 0f;
        whiteFadeImage.color = new Color(0.247f, 0.247f, 0.247f, 1f);
        frontWhiteFade.color = new Color(1f, 1f, 1f, 0f);
        finishScene.challengeDefeat = true;
        finishScene.textProgress = progreso.text;
        finishScene.FinishSceneMenu();
    }
}
